...
import org.jqassistant.plugin.jmolecules.set.cqrs.Command1;
...
public class CommandIT extends AbstractJMoleculesPluginIT {
    ...
    public void command() throws RuleException {
        ...
        assertThat(rows.get(0).get("commandNamespace")).isEqualTo("org.jqassistant.plugin.jmolecules.set.cqrs");
